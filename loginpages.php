...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="lf.php" title="Get Back Your Lost Items">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0 float-xs-right">
          <li class="nav-item">
            <a class="nav-link" href="lf.php">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="lost.php">Lost Item</a>
          </li>
          <li class="nav-item">
